 ...
 */
public class SerialInputOutputManager2 implements Runnable {

    private static final String TAG = SerialInputOutputManager2.class.getSimpleName();
    ...
    public interface Listener {
        ...
        /**
         * Called when {@link SerialInputOutputManager2#run()} aborts due to an error.
         */
        public void onRunError(Exception e);
    }

    public SerialInputOutputManager2(UsbSerialPort serialPort) {
        mSerialPort = serialPort;
    }

    public SerialInputOutputManager2(UsbSerialPort serialPort, Listener listener) {
        mSerialPort = serialPort;
        mListener = listener;
    }
